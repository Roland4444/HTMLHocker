...
<div>
    ...
    <table style="padding-top: -30px;">
        ...
        <tr class="main-description">
            ...
            <td colspan="3" class="bottom-border compact-line" id="customer">{{ $document->payer->legal_name }}, ИНН {{ $document->payer->inn }}, {{ $document->payer->address  }}, тел.: {{ $document->payer->phone }}, {{ $document->payer->account }}</td>
            <td class="compact-line">&nbsp;</td>
        </tr>
        <tr class="main-description">
            <td class="compact-line">&nbsp;</td>
